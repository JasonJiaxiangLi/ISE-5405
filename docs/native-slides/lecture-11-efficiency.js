...
export const efficiencySlides=[
  ...
  slide('complete-story','Connect the geometry to the computational work',raw`<div class="l10-stack"><section class="l10-box" data-tone="blue"><h3>Geometry explains the step</h3><p>Replace one basic point. Reduced cost predicts the objective slope; the ratio test selects a feasible replacement. A positive improving step lowers the intersection; a degenerate pivot can leave it unchanged.</p></section><section class="l10-box" data-tone="green"><h3>Two factors determine the work</h3><p>Count work per pivot and the number of pivots. Distinguish worst-case, average-case, and smoothed claims; finite termination alone does not guarantee a short run.</p></section><p><strong>Starting and finishing:</strong> Phase I supplies a feasible basis or proves infeasibility. An anticycling rule supports termination while Phase II optimizes the original objective.</p></div>`,[2,90,118,122,154]),
];
