/** Optional 3D cycling appendix. The main lecture retains BT Example 3.6. */
...
export const appendixSlides=[
 ...
 {key:'cycle-dictionary',title:'Start with the Slack Dictionary',referencePages:[4],className:'l10-cycle-slide',
 ...
 <section class="l10-box" data-tone="blue" data-reveal="2"><p>Set \(x_1=x_2=x_3=0\). Then \((x_4,x_5,x_6,x_7)=(0,0,0,1)\).</p><p>Three basic variables are zero: this basis is <strong>degenerate</strong>.</p></section></section><section class="l10-cycle-visual">${fig}<p>A tight plane may touch the pyramid only at O.</p></section></div>`,{planes:true}),},
 ...
 checkpoint:{prompt:'In the 3D example, what repeats after the six zero-length pivots?',choices:['Only the objective value','The initial basis and complete dictionary','Only the entering variable','A positive-length edge step'],correctIndex:1,explanation:'The sixth pivot restores the initial basis and every dictionary coefficient. The fixed pivot rules then repeat the same six choices. The point and objective were unchanged throughout.',autoOpen:true},},
  {
